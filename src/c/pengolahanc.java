        ...
        if (cekkualitas >= 1) {
            ...
            if (Pilih == 0) {
                ...
                molah.tambahProduk(idproduk, getIdKualitas, mplayer.getIdPlayer(username),
                        (maset.getJmlProduk(username, idproduk, getIdKualitas) + jmlproduk));
